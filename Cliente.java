    ...
    public static void main(String args[]){
        ...
        do{
            ...
            if(opcion=='a'){
            	...
            	r.genero = genero;
                try{
                URL url = new URL("http://ip-de-la-máquina-virtual:8080/Servicio/rest/ws/alta_usuario");
                ...
                try{
                    ...
                    URL url = new URL("http://ip-de-la-máquina-virtual:8080/Servicio/rest/ws/borra_usuario");
                    HttpURLConnection conexion = (HttpURLConnection) url.openConnection();
                    conexion.setDoOutput(true);
                    // en este caso utilizamos el método POST de HTTP
                    conexion.setRequestMethod("POST");
